              ...
              <AreaChart data={deteriorationData} margin={{ top: 5, right: 0, left: -20, bottom: 0 }}>
                <defs>
                  <linearGradient id="colorRiskFill" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="hsl(var(--pink-400))" stopOpacity={0.6}/>
                    <stop offset="95%" stopColor="hsl(var(--pink-400))" stopOpacity={0}/>
                  </linearGradient>
                  <linearGradient id="colorRiskStroke" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="hsl(var(--pink-400))" stopOpacity={1}/>
                    <stop offset="95%" stopColor="hsl(var(--pink-500))" stopOpacity={1}/>
                  </linearGradient>
                </defs>
